        ...
        <div id='add-stock-content'>
            ...
            <div id='add-stock-form'>
                ...
                <table>
                    ...
                    <tr>    
                        <th><img src="no_book_cover.jpg"></th>
                        <th>10</th>
                        <th>{{ $shoppingCart-> qty}}</th>
                        <th>10</th>
                        <th><a href="<?php echo url('shoppingCart') ?>"  style="text-align:right; padding-top: 8px;">
                            <img src="{{ asset('images/delete_button.png') }}" width="40px" height="40px"></a></th>
                    <tr>
                    @endforeach
                </table>
                </div>
