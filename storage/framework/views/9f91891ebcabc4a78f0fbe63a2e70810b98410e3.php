            ...
            <h1><font face='Impact'>Sign Up</font></h1>
                ...
                <form action="<?php echo e(route('register-user')); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Username" name="userName" value="<?php echo e(old('userName')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="1 - User | 2 - Admin" name="privilige" value="<?php echo e(old('privilige')); ?>">
                        <span class="text-danger"><?php $__errorArgs = ['privilige'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
</html><?php /**PATH C:\HongKai\Software\xampp\htdocs\Book_Shop\resources\views/auth/registration.blade.php ENDPATH**/ ?>